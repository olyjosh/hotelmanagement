 ...
 * @author mac
 */
public final class OnlineFoodOrder implements Initializable {
    ...
    public OnlineFoodOrder(Hotels app) {
        this.app =app;
...
//                });
    ...
    private void orders(){
        JSONObject foods = nav.fetchFoodsOrders(State.channel_Mobile, null, null);
        if(foods!=null){
            try {
